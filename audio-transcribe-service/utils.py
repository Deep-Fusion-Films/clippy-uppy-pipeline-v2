...
logger = logging.getLogger("audio-transcribe-service")
...
def download_from_gcs(bucket: str, file_name: str, local_path: str):
    ...
    log("Downloaded audio", bucket=bucket, file=file_name)
...
def upload_to_gcs(bucket: str, file_name: str, local_path: str):
    ...
    log("Uploaded transcript", bucket=bucket, file=file_name)
